    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>">
            ...
            <p class="text-center text-sm text-gray-500 mt-4">
                Belum punya akun?
                <a href="<?php echo e(route('register')); ?>" class="text-pink-600 font-semibold hover:underline">Daftar</a>
            </p>
        </form>
    </div>

</body>
</html><?php /**PATH C:\xampp2\htdocs\spk-moisturizer\resources\views/auth/login.blade.php ENDPATH**/ ?>