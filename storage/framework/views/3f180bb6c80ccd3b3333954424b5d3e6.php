...
<body class="bg-pink-50 min-h-screen flex items-center justify-center">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        ...
        <p class="text-center text-sm text-gray-500 mt-4">
            Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="text-pink-600 font-semibold hover:underline">Login</a>
        </p>
    </div>

</body>
</html><?php /**PATH C:\xampp2\htdocs\spk-moisturizer\resources\views/auth/register.blade.php ENDPATH**/ ?>