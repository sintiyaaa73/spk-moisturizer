...
<?php $__env->startSection('content'); ?>
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.alternatif.create')); ?>"
    ...
    <div class="bg-white rounded-xl shadow overflow-hidden">
        <table class="w-full text-sm">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $alternatif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="border-t hover:bg-gray-50">
                    <td class="px-4 py-3"><?php echo e($i + 1); ?></td>
                    <td class="px-4 py-3 font-semibold text-pink-600"><?php echo e($item->kode_alternatif); ?></td>
                    ...
                    <td class="px-4 py-3 flex gap-2">
                        <a href="<?php echo e(route('admin.alternatif.edit', $item->id)); ?>"
                            class="bg-yellow-400 hover:bg-yellow-500 text-white px-3 py-1 rounded text-xs">Edit</a>
                        <form method="POST" action="<?php echo e(route('admin.alternatif.destroy', $item->id)); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp2\htdocs\spk-moisturizer\resources\views/admin/alternatif/index.blade.php ENDPATH**/ ?>